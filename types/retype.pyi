...
def remove_function_signature_type_comment(body: Node) -> None: ...
def ensure_no_annotation(ann: Optional[ast3.AST]) -> None: ...
def copy_type_comment_to_annotation(arg: ast3.AST) -> None: ...
def copy_type_comments_to_annotations(args: ast3.arguments) -> None: ...
def copy_arguments_to_annotations(args: ast3.arguments, type_comment: List[ast3.AST], *, is_method: bool = False) -> None: ...
def parse_type_comment(type_comment: str) -> ast3.AST: ...
def parse_signature_type_comment(type_comment: str) -> Tuple[Union[ast3.AST, List[ast3.AST]], ast3.AST]: ...
def get_function_signature(fun: ast3.FunctionDef, *, is_method: bool = False) -> Tuple[ast3.arguments, ast3.AST]: ...
