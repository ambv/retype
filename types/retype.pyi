...
def retype_file(src: Path, pyi_dir: Path, targets: Path, *, quiet: bool = False) -> Path: ...
def retype_path(src: Path, pyi_dir: Path, targets: Path, *, src_explicitly_given: bool = False, quiet: bool = False) -> Iterator[Tuple[Path, str]]: ...
def main(src: Sequence[str], pyi_dir: str, target_dir: str, quiet: bool) -> None: ...
