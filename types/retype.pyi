...
def get_function_signature(
    fun: ast3.FunctionDef, *, is_method: bool = False
) -> Tuple[ast3.arguments, Optional[ast3.expr]]: ...
def annotate_return(
    function: List[_LN], ast_returns: Optional[ast3.AST], offset: int
) -> None: ...
def annotate_parameters(
    parameters: _LN, ast_args: ast3.arguments, *, is_method: bool = False
) -> None:
...
def make_import(  # type: ignore
    *names: ast3.alias, from_module: Optional[str] = None
) -> Node:
    imports: List[_LN]
...
def fix_signature_annotation_type_comment(
    node: Node, last: Node, *, offset: int
) -> None: ...
...
def retype_file(
    src: Path, pyi_dir: Path, targets: Path, *, quiet: bool = False, hg: bool = False
) -> Path: ...
def retype_path(
    src: Path,
    pyi_dir: Path,
    targets: Path,
    *,
    src_explicitly_given: bool = False,
    quiet: bool = False,
    hg: bool = False,
