...
def parse_signature_type_comment(type_comment: str) -> Tuple[Union[ast3.expr, List[ast3.expr]], ast3.expr]: # type: ignore
...
def make_import(*names: ast3.alias, from_module: Optional[str] = None) -> Node: # type: ignore
    imports: List[_LN]
